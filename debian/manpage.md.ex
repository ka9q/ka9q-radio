% ka9q-radio(SECTION) | User Commands
%
% "April 28 2026"
...
ka9q-radio - program to do something

# SYNOPSIS

**ka9q-radio** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**ka9q-radio** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **ka9q-radio** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**ka9q-radio** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    ka9q-radio. See **foo.conf**(5) for further details.
...
**ka9q-radio** provides some return codes, that can be used in scripts:
