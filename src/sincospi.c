...
#if 1
  // sinpi/cospi are defined in misc.h if the librqry doesn't have them
  double ss = sinpi(z);
  double cc = cospi(z);
#else
#define PI_D (3.141592653589793238462643383279502884)
  double const piz = PI_D * z;
  double ss = sin(piz);
  double cc = cos(piz);
#endif
